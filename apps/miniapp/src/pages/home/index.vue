...
<style scoped>
.screen{min-height:100vh;padding:calc(188rpx + var(--status-bar-height)) 32rpx 190rpx;box-sizing:border-box;background:linear-gradient(180deg,#fbf9ff 0,#f8f7fc 460rpx,var(--canvas) 100%)}
