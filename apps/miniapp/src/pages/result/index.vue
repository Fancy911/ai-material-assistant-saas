...
<style scoped>
.page{min-height:100vh;padding:calc(32rpx + var(--status-bar-height)) 32rpx 70rpx;box-sizing:border-box;background:var(--canvas)}.topbar{height:72rpx;display:flex;align-items:center;justify-content:space-between}.back,.home-link{color:var(--violet);font-size:25rpx;font-weight:700}.top-title{color:var(--ink);font-size:29rpx;font-weight:800}.status{display:flex;align-items:center;gap:17rpx;margin-top:38rpx}.status-icon{width:70rpx;height:70rpx;flex:none;display:grid;place-items:center;border-radius:23rpx;background:#e6f8ef;color:#279964;font-size:33rpx;font-weight:800}.status-title,.detail{display:block}.status-title{color:var(--ink);font-size:35rpx;font-weight:800;letter-spacing:-1rpx}.detail{margin-top:7rpx;color:var(--muted);font-size:23rpx}.preview,.gallery-card{height:460rpx;margin-top:40rpx;border:1rpx solid #33284d;border-radius:29rpx;background:linear-gradient(145deg,#30253f,#21192f);overflow:hidden;color:#fff;font-size:24rpx;box-shadow:0 15rpx 35rpx rgba(43,29,68,.17)}.preview video{width:100%;height:100%}.gallery-card{position:relative}.gallery{width:100%;height:100%}.gallery-image-wrap{position:relative;width:100%;height:100%;display:flex;align-items:center;justify-content:center}.gallery-image-wrap image{width:100%;height:100%}.page-count{position:absolute;right:18rpx;top:18rpx;padding:8rpx 15rpx;border-radius:99rpx;background:rgba(15,8,26,.5);font-size:21rpx}.preview-empty{height:100%;display:flex;flex-direction:column;justify-content:center;align-items:center;text-align:center;gap:18rpx}.play{width:84rpx;height:84rpx;border-radius:50%;display:grid;place-items:center;background:#fff;color:var(--violet);font-size:31rpx}.facts{display:flex;margin:26rpx 0;padding:25rpx 7rpx;border:1rpx solid #e9e3f1;border-radius:23rpx;background:rgba(255,255,255,.7);justify-content:space-around}.facts view{display:flex;flex-direction:column;gap:9rpx;color:var(--muted);font-size:21rpx}.facts b{color:#3a3344;font-size:24rpx}.facts .success{color:#299768}.text-card{margin:0 0 27rpx;padding:25rpx;border:1rpx solid #e9e3f1;border-radius:24rpx;background:rgba(255,255,255,.74)}.text-card-head{display:flex;align-items:flex-start;justify-content:space-between;gap:16rpx}.text-title,.text-subtitle{display:block}.text-title{color:var(--ink);font-size:27rpx;font-weight:800}.text-subtitle{margin-top:6rpx;color:var(--muted);font-size:20rpx}.copy-text{padding:9rpx 16rpx;border-radius:13rpx;background:var(--violet-soft);color:var(--violet);font-size:21rpx;font-weight:700}.material-title,.material-content{display:block;white-space:pre-wrap;line-height:1.68}.material-title{margin-top:23rpx;color:#393142;font-size:28rpx;font-weight:800}.material-content{margin-top:15rpx;color:#6c6476;font-size:25rpx}.actions{display:flex;flex-direction:column;gap:15rpx}.save,.secondary,.again{margin:0;height:92rpx;line-height:92rpx;border-radius:18rpx;font-size:27rpx;font-weight:700}.save{background:linear-gradient(105deg,#6f3ff5,#8a61f6);color:#fff;box-shadow:0 11rpx 22rpx rgba(92,56,205,.19)}.secondary{background:var(--violet-soft);color:#5d37cd}.again{border:1rpx solid #e2dbea;background:var(--surface);color:#5e566a}.note{display:block;margin:28rpx 20rpx 0;color:var(--muted);text-align:center;font-size:21rpx;line-height:1.55}
</style>
